...
public class GUI extends Application {
    ...
    private void setButtonLayout(Button button, int x, int y) {
        button.setLayoutX(x);
        button.setLayoutY(y);
    }
